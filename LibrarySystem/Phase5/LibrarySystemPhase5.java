...
public class LibrarySystemPhase5 {

	private static <T extends Sortable> void quickSort(ArrayList<T> list, int low, int high) {
		if (low < high) {
	...
	private static <T extends Sortable> Boolean binarySearch(ArrayList<T> list, String elementToSearch, int low, int high) {
		if (low > high) {
			return false;
		}
	...
	public static void main(String[] args) {		
		...
		// Using quicksort directly
		quickSort(libraryBooks, 0, libraryBooks.size() - 1);
		...
		// Using quicksort directly
		quickSort(libraryMembers, 0, libraryMembers.size() - 1);
		...
		isBookFound = binarySearch(libraryBooks, bookToSearch, 0, libraryBooks.size() - 1);
		...
		// Using binary search directly
		isMemberFound = binarySearch(libraryMembers, memberToSearch, 0, libraryMembers.size() - 1);
